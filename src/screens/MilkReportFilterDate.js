...
class MilkReportFilterDate extends React.Component {
    ...
    return (
        ...
        >
            <View style={styles.container}>
                ...
                <TouchableOpacity onPress={()=>this.props.navigation.navigate("MilkReportFilterResult")} style={{justifyContent: 'flex-end',backgroundColor:'#0576DC',height:30,alignItems:'center'}} >
...
export default MilkReportFilterDate;