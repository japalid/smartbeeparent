...
import MilkReportItems from "./MilkReportList/Components/MilkReportItems";
...
class MilkReport extends React.Component {
  ...
  _renderItem = ({item}) => <MilkReportItems item={item} navigation={this.props.navigation} />
            ...
            <View style={styles.container}>
                <ImageBackground style={styles.imageBackground} source={srcBg}>
                    ...
                    >
                        <Text>Date : </Text>
                        <TouchableOpacity
                            onPress={()=>this.props.navigation.navigate('MilkReportFilterDate')}
                        >
