...
import { View, ImageBackground, StyleSheet, Image, Text, TouchableOpacity, Platform, TextInput, Dimensions, StatusBar } from "react-native";
...
class IncidentActivity extends React.Component {
  ...
  render() {
    return (
        <View style={styles.container}>
            <StatusBar backgroundColor="#01DED7" />
            <View style={{flexDirection:'row',backgroundColor:'#01DED7',height:70 }}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <View style={{flexDirection:'row',position:'absolute',bottom:0,height:40,alignItems:'center',justifyContent:'center'}}>
                  <TouchableOpacity
                      style={{width:width/2,backgroundColor:'#00DED7',height:60,alignItems:'center',justifyContent:'center'}}
                  >
                      <Text style={{color:'#ffffff',alignItems:'center',fontSize:18}}>SAVE</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                      style={{width:width/2,backgroundColor:'#00C7C1',height:60,alignItems:'center',justifyContent:'center'}}
                  >
