...
class MilkActivity extends React.Component {
  ...
  render() {
    return (
        <View style={styles.container}>
            <StatusBar backgroundColor="#FDDE69" />
            <View style={{flexDirection:'row',backgroundColor:'#FDDE69',height:70 }}>
                <View style={{marginTop: (Platform.OS) == 'ios' ? 30 : 0,alignItems:'center',justifyContent:'space-between',flexDirection:'row',width:width}}>
                    ...
                    <View style={{margin:10}}>
                        <Text style={{color:'#fff',fontSize:16,fontWeight:'bold'}}>Milk</Text>
                    </View>
                    </View>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={{flexDirection:'row',position:'absolute',bottom:0,height:40,alignItems:'center',justifyContent:'center'}}>
              <TouchableOpacity
                  style={{width:width/2,backgroundColor:'#FDDE69',height:60,alignItems:'center',justifyContent:'center'}}
              >
                  <Text style={{color:'#ffffff',alignItems:'center',fontSize:18}}>SAVE</Text>
              </TouchableOpacity>
              <TouchableOpacity
                  style={{width:width/2,backgroundColor:'#E4C449',height:60,alignItems:'center',justifyContent:'center'}}
              >
