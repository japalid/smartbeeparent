...
class MedicalReportFilterDate extends React.Component {
    ...
    return (
        ...
        >
            <View style={styles.container}>
                ...
                <TouchableOpacity onPress={()=>this.props.navigation.navigate("MedicalReportFilterResultBerat")} style={{justifyContent: 'flex-end',backgroundColor:'#0576DC',height:30,alignItems:'center'}} >
...
export default MedicalReportFilterDate;