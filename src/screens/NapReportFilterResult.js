...
var srcImage = require("../images/napimage.png");

class NapReportFilterResult extends React.Component {
                ...
                <ImageBackground style={styles.imageBackground} source={srcBg}>
                    <View style={{alignItems:'center',justifyContent:'center',marginTop:20}}>
                        <View style={{width:166,height:162,borderRadius:80,alignItems:'center',justifyContent:'center'}}>
                            <Image source={srcImage} style={{width:163,height:147}} />
                        </View>
                    </View>
                    <View
...
export default NapReportFilterResult;