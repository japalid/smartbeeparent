...
class QuestionTall extends React.Component {
        ...
        <ImageBackground source={srcImage} style={styles.imageBackground}>
                ...
                <View style={styles.container}>
                  ...
                  <View style={{width:'100%'}}>
                    ...
                    <Text>How tall is he/she?</Text>


                    <FormLabel style={styles.textLabel}>Height</FormLabel>
                  ...
                  style={{marginTop:50}}
                    ...
                    onPress={() => this.props.navigation.navigate("QuestionWeight")}
                  />
