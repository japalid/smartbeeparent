...
class ActivityReportFilterResultBerat extends React.Component {
        ...
        >
            <View style={styles.container}>
                ...
                <View style={{flexDirection:'row',alignItems:"center",justifyContent:'center',marginTop:15,marginBottom:15}}>
                    ...
                    >
                        <Text style={{color:'#2E313C',fontSize:15,paddingLeft:15,paddingRight:15,paddingTop:10,paddingBottom:10}}>Tinggi</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                    onPress={()=>{this.props.navigation.pop();this.props.navigation.navigate("MedicalReportFilterResultSuhu")}}
                    style={{backgroundColor:'#A1CF52',borderColor:'#E2DEDF',borderWidth:1,borderTopRightRadius:10,borderBottomRightRadius:10}}
                    >
                        <Text style={{color:'#FFFFFF',fontSize:15,paddingLeft:15,paddingRight:15,paddingTop:10,paddingBottom:10}}>Suhu</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={{justifyContent:'center',alignItems:'center'}}>
                    <LineChart
                        ...
                        height={220}
                        chartConfig={{
                        backgroundColor: '#A1CF52',
                        backgroundGradientFrom: '#A1CF52',
                        backgroundGradientTo: '#A1CF52',
...
export default ActivityReportFilterResultBerat;