            ...
            <View style={styles.container}>
                <ImageBackground style={styles.imageBackground} source={srcBg}>
                    <View style={{alignItems:'center',justifyContent:'center',marginTop:20}}>
                        <ImageBackground source={srcBorder} style={{width:166,height:170}}>
                            <View style={{width:166,height:162,borderRadius:80,alignItems:'center',justifyContent:'center'}}>
                                <Image source={srcExample} style={{width:123,height:125}} />
                            </View>
                        </ImageBackground>
                    </View>
                    <View
                    ...
                    >
                        <Text>Date : </Text>
                        <TouchableOpacity
                            onPress={()=>this.props.navigation.navigate('ActivityReportFilterDate')}
                        >
