...
import IncidentReportItems from "./IncidentReportList/Components/IncidentReportItems";
...
var srcExample = require("../images/incidentimage.png");

class IncidentReportFilterResult extends React.Component {
  ...
  _renderItem = ({item}) => <IncidentReportItems item={item} navigation={this.props.navigation} />
...
export default IncidentReportFilterResult;