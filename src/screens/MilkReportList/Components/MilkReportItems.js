...
var srcIcon = require('../../../images/icon/milkiconlist.png');
...
class MilkReportItems extends React.Component {
...
MilkReportItems.propTypes = propTypes;
...
export default MilkReportItems;
