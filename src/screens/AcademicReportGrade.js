...
class AcademicReportGrade extends React.Component {
            ...
            <View style={styles.container}>
                ...
                <View style={{alignItems:'center',justifyContent:'space-between',borderColor:'#E2DEDF',borderWidth:1,width:Dimensions.get('window').width - 30,margin:15,backgroundColor:'#F8F8F9',flexDirection:'row',borderRadius:15,padding:15}}>
                    ...
                    <View style={{flexDirection:'row',alignItems:"center",justifyContent:'center',marginTop:15,marginBottom:15,borderRadius:10}}>
                        ...
                        >
                            <Text style={{color:'#2E313C',fontSize:15,paddingLeft:15,paddingRight:15,paddingTop:10,paddingBottom:10}}>Graph</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                        ...
                        >
                            <Text style={{color:'#FFFFFF',fontSize:15,paddingLeft:15,paddingRight:15,paddingTop:10,paddingBottom:10}}>Grade</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    >
                        <Text>Date : </Text>
                        <TouchableOpacity
                            onPress={()=>this.props.navigation.navigate('AcademicReportFilterDate')}
                        >
                    ...
                    <View style={{justifyContent:'center',alignItems:'center',borderRadius:10,flexDirection:'column',marginTop:20,alignSelf:'stretch',marginLeft:15,marginRight:15,shadowColor:'#000',shadowOffset:{width:1, height:1}, shadowRadius:2,elevation:1,backgroundColor:'#FFFFFF',shadowOpacity:0.5}}>
                        ...
                        <Text style={{fontSize:15,color:'#3D4356',marginTop:5,marginLeft:5,marginBottom:5,padding:10,justifyContent:'center'}}>Ajarkan anak anda untuk berhati hati saat bermain</Text>
                    </View>
...
export default AcademicReportGrade;