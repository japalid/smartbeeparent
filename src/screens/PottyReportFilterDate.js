    ...
    return (
        ...
        >
            <View style={styles.container}>
                ...
                <TouchableOpacity onPress={()=>this.props.navigation.navigate("PottyReportFilterResult")} style={{justifyContent: 'flex-end',backgroundColor:'#0576DC',height:30,alignItems:'center'}} >
